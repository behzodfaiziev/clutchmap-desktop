...
class CreateOpponentDialog extends StatefulWidget {
  const CreateOpponentDialog({super.key});

  @override
  State<CreateOpponentDialog> createState() => _CreateOpponentDialogState();
}

class _CreateOpponentDialogState extends State<CreateOpponentDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Create Opponent'),
      content: Form(
        key: _formKey,
        ...
        BlocListener<OpponentBloc, OpponentState>(
          ...
          listener: (context, state) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Opponent created')),
            );
          },
